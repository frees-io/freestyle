...
libraryDependencies += "io.frees" %% "frees-cache"              % "0.5.0"
libraryDependencies += "io.frees" %% "frees-config"             % "0.5.0"
libraryDependencies += "io.frees" %% "frees-logging"            % "0.5.0"

// optional - integrations
libraryDependencies += "io.frees" %% "frees-cache-redis"        % "0.5.0"
libraryDependencies += "io.frees" %% "frees-doobie"             % "0.5.0"
libraryDependencies += "io.frees" %% "frees-fetch"              % "0.5.0"
libraryDependencies += "io.frees" %% "frees-akka"               % "0.5.0"
libraryDependencies += "io.frees" %% "frees-finch"              % "0.5.0"
libraryDependencies += "io.frees" %% "frees-http-client"        % "0.5.0"
libraryDependencies += "io.frees" %% "frees-http4s"             % "0.5.0"
libraryDependencies += "io.frees" %% "frees-monix"              % "0.5.0"
libraryDependencies += "io.frees" %% "frees-play"               % "0.5.0"
libraryDependencies += "io.frees" %% "frees-slick"              % "0.5.0"
libraryDependencies += "io.frees" %% "frees-twitter-util"       % "0.5.0"
```
...
libraryDependencies += "io.frees" %%% "frees-async-monix"       % "0.5.0"
libraryDependencies += "io.frees" %%% "frees-cache"             % "0.5.0"
libraryDependencies += "io.frees" %%% "frees-http-client"       % "0.5.0"
libraryDependencies += "io.frees" %%% "frees-logging"           % "0.5.0"
