...
Fear not. Freestyle provides a [modular system](/docs/src/main/tut/docs/core/modules/) to achieve Onion style architectures
...
[Continue to Modules](/docs/src/main/tut/docs/core/modules/)
